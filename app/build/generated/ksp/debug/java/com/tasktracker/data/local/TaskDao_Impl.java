  ...
  public TaskDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `tasks` (`id`,`title`,`description`,`startTime`,`endTime`,`label`,`priority`,`isCompleted`,`createdAt`,`updatedAt`,`isRecurring`,`recurringPattern`,`notificationEnabled`,`notificationMinutesBefore`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        final String _tmp_3 = __converters.fromTaskPriority(entity.getPriority());
        ...
        final int _tmp_7 = entity.isRecurring() ? 1 : 0;
        ...
        final int _tmp_8 = entity.getNotificationEnabled() ? 1 : 0;
        statement.bindLong(13, _tmp_8);
        statement.bindLong(14, entity.getNotificationMinutesBefore());
      }
    };
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `tasks` SET `id` = ?,`title` = ?,`description` = ?,`startTime` = ?,`endTime` = ?,`label` = ?,`priority` = ?,`isCompleted` = ?,`createdAt` = ?,`updatedAt` = ?,`isRecurring` = ?,`recurringPattern` = ?,`notificationEnabled` = ?,`notificationMinutesBefore` = ? WHERE `id` = ?";
      }
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpPriority = __converters.toTaskPriority(_tmp_4);
            ...
            _item = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpStartTime,_tmpEndTime,_tmpLabel,_tmpPriority,_tmpIsCompleted,_tmpCreatedAt,_tmpUpdatedAt,_tmpIsRecurring,_tmpRecurringPattern,_tmpNotificationEnabled,_tmpNotificationMinutesBefore);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _tmpPriority = __converters.toTaskPriority(_tmp_3);
            final boolean _tmpIsCompleted;
            final int _tmp_4;
      ...
      public Task call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final int _tmpNotificationMinutesBefore;
            _tmpNotificationMinutesBefore = _cursor.getInt(_cursorIndexOfNotificationMinutesBefore);
            _result = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpStartTime,_tmpEndTime,_tmpLabel,_tmpPriority,_tmpIsCompleted,_tmpCreatedAt,_tmpUpdatedAt,_tmpIsRecurring,_tmpRecurringPattern,_tmpNotificationEnabled,_tmpNotificationMinutesBefore);
          } else {
            _result = null;
          }
          return _result;
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final TaskPriority _tmpPriority;
            final String _tmp_5;
            _tmp_5 = _cursor.getString(_cursorIndexOfPriority);
            _tmpPriority = __converters.toTaskPriority(_tmp_5);
            final boolean _tmpIsCompleted;
            final int _tmp_6;
            ...
            final boolean _tmpNotificationEnabled;
            final int _tmp_12;
            _tmp_12 = _cursor.getInt(_cursorIndexOfNotificationEnabled);
            _tmpNotificationEnabled = _tmp_12 != 0;
            final int _tmpNotificationMinutesBefore;
            _tmpNotificationMinutesBefore = _cursor.getInt(_cursorIndexOfNotificationMinutesBefore);
            _item = new Task(_tmpId,_tmpTitle,_tmpDescription,_tmpStartTime,_tmpEndTime,_tmpLabel,_tmpPriority,_tmpIsCompleted,_tmpCreatedAt,_tmpUpdatedAt,_tmpIsRecurring,_tmpRecurringPattern,_tmpNotificationEnabled,_tmpNotificationMinutesBefore);
            _result.add(_item);
