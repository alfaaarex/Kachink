...
public abstract class Hilt_TaskActionReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((TaskActionReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectTaskActionReceiver(UnsafeCasts.<TaskActionReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
